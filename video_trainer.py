...
class Trainer(object):
    ...
    def build_model(self,args):
        self.model = make_3d_network(args)
    ...
    def video_test(self):
            f = open("PSNR_SSIM_lr_data_RGB_video_Avg_medium.txt", "a")
            f1 = open("PSNR_SSIM_lr_data_RGB_video_SR_medium.txt", "a")
            f2 = open("PSNR_SSIM_lr_data_RGB_video_VFI_medium.txt", "a")
            f3 = open("PSNR_SSIM_lr_data_RGB_videoo_Alldetil_medium.txt", "a")
